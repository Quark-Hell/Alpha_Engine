...
static ::_pb::Metadata file_level_metadata_protofiles_2ftest_2eproto[1];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_protofiles_2ftest_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_protofiles_2ftest_2eproto = nullptr;

const uint32_t TableStruct_protofiles_2ftest_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_protofiles_2ftest_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\025protofiles/test.proto\"#\n\006Person\022\014\n\004nam"
  "e\030\001 \001(\t\022\013\n\003age\030\002 \001(\005b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_protofiles_2ftest_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_protofiles_2ftest_2eproto = {
    false, false, 68, descriptor_table_protodef_protofiles_2ftest_2eproto,
    "protofiles/test.proto",
    &descriptor_table_protofiles_2ftest_2eproto_once, nullptr, 0, 1,
    schemas, file_default_instances, TableStruct_protofiles_2ftest_2eproto::offsets,
    file_level_metadata_protofiles_2ftest_2eproto, file_level_enum_descriptors_protofiles_2ftest_2eproto,
    file_level_service_descriptors_protofiles_2ftest_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_protofiles_2ftest_2eproto_getter() {
  return &descriptor_table_protofiles_2ftest_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_protofiles_2ftest_2eproto(&descriptor_table_protofiles_2ftest_2eproto);
...
::PROTOBUF_NAMESPACE_ID::Metadata Person::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_protofiles_2ftest_2eproto_getter, &descriptor_table_protofiles_2ftest_2eproto_once,
      file_level_metadata_protofiles_2ftest_2eproto[0]);
}
